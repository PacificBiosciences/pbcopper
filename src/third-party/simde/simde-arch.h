...
#elif defined(__arm__) || defined(__thumb__) || defined(__TARGET_ARCH_ARM) || defined(_ARM) || \
    defined(_M_ARM) || defined(_M_ARM)
...
#define SIMDE_ARCH_POWER 620
    ...
    defined(__PPC__) || defined(_ARCH_PPC) || defined(__ppc)

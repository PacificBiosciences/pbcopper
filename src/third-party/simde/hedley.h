...
#define HEDLEY_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_(xpr)  \
    HEDLEY_DIAGNOSTIC_PUSH                                 \
    _Pragma("clang diagnostic ignored \"-Wc++98-compat\"") \
        _Pragma("clang diagnostic ignored \"-Wc++17-extensions\"") xpr HEDLEY_DIAGNOSTIC_POP
#endif
#else
#define HEDLEY_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_(xpr) \
    HEDLEY_DIAGNOSTIC_PUSH                                \
...
#define HEDLEY_DEPRECATED_FOR(since, replacement) \
    ...
    HEDLEY_TI_ARMCL_VERSION_CHECK(18, 1, 0) || HEDLEY_TI_CL6X_VERSION_CHECK(8, 3, 0) || \
    HEDLEY_TI_CL7X_VERSION_CHECK(1, 2, 0) || HEDLEY_TI_CLPRU_VERSION_CHECK(2, 3, 0)
...
#define HEDLEY_DEPRECATED(since) \
    HEDLEY_DIAGNOSTIC_DISABLE_CPP98_COMPAT_WRAP_([[deprecated("Since " #since)]])
#define HEDLEY_DEPRECATED_FOR(since, replacement) \
...
#define HEDLEY_UNLIKELY(expr) __builtin_expect(!!(expr), 0)
    ...
    HEDLEY_TI_VERSION_CHECK(15, 12, 0) || HEDLEY_TI_ARMCL_VERSION_CHECK(4, 7, 0) ||      \
    HEDLEY_TI_CL430_VERSION_CHECK(3, 1, 0) || HEDLEY_TI_CL2000_VERSION_CHECK(6, 1, 0) || \
    HEDLEY_TI_CL6X_VERSION_CHECK(6, 1, 0) || HEDLEY_TI_CL7X_VERSION_CHECK(1, 2, 0) ||    \
    HEDLEY_TI_CLPRU_VERSION_CHECK(2, 1, 0) || HEDLEY_TINYC_VERSION_CHECK(0, 9, 27) ||    \
...
#define HEDLEY_PURE _Pragma("does_not_write_global_data")
    ...
    (HEDLEY_TI_CL430_VERSION_CHECK(2, 0, 1) || HEDLEY_TI_CL6X_VERSION_CHECK(4, 0, 0) || \
     HEDLEY_TI_CL7X_VERSION_CHECK(1, 2, 0))
...
#define HEDLEY_RESTRICT restrict
    ...
    HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) ||           \
    HEDLEY_PGI_VERSION_CHECK(17, 10, 0) || HEDLEY_TI_CL430_VERSION_CHECK(4, 3, 0) ||     \
    HEDLEY_TI_CL2000_VERSION_CHECK(6, 2, 4) || HEDLEY_TI_CL6X_VERSION_CHECK(8, 1, 0) ||  \
    HEDLEY_TI_CL7X_VERSION_CHECK(1, 2, 0) ||                                             \
...
#elif defined(__cplusplus) &&                                                            \
    (HEDLEY_TI_ARMCL_VERSION_CHECK(5, 2, 0) || HEDLEY_TI_CL430_VERSION_CHECK(4, 3, 0) || \
...
#define HEDLEY_IS_CONSTEXPR_(expr) \
    ...
    HEDLEY_TI_CL430_VERSION_CHECK(18, 12, 0) || defined(HEDLEY_TI_CL2000_VERSION) || \
...
#undef HEDLEY_STATIC_ASSERT
    ...
    ((defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)) ||               \
     ...
     HEDLEY_GCC_VERSION_CHECK(6, 0, 0) || HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) ||  \
...
#define HEDLEY_REQUIRE(expr)                             \
    ...
    _Pragma("clang diagnostic ignored \"-Wgcc-compat\"") \
        __attribute__((diagnose_if(!(expr), #expr, "error"))) HEDLEY_DIAGNOSTIC_POP
